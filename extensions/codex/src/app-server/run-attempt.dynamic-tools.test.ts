...
describe("runCodexAppServerAttempt dynamic tools", () => {
  it("preserves model order across queued dynamic tool outcomes", async () => {
    ...
    await expect(slowCall).resolves.toMatchObject({ success: false });
